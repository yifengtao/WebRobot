'''
Usage: 
python curlfile.py > Make
. Make
Function: 
Generate the Make file to download the drug library, dock the drug with the ligand, 
output docking results, sort the result, delete downloaded files.
'''
